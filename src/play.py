...
def call(state, search_type='minmax'):
    ...
    benchmark(lambda: search_instance.search(iterative_deepening=True, time_limit=20, depth=depth), 'alpha_beta',fen=state['board'], repetitions=1, depth=depth, move_output=True, include_move_count=True)
