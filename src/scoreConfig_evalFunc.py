...
class ScoreConfig:
    ...
    def Version2(self, maxPlayer: Player, player: Player, board: list[np.uint64] = []):
        ...
        if (len(board) == 4):
            blueScoreHitPawns, blueScoreHitKnights = self.createScores(self, Player.Blue, board, hitPointsForPawns,
                                                                       hitPointsForKnights)
            redScoreHitPawns, redScoreHitKnights = self.createScores(self, Player.Red, board, hitPointsForPawns,
                                                                     hitPointsForKnights)
