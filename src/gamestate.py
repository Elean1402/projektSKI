...
class GameState:
    ...
    figureStack = {_ARR_INDEX_R: 1, _ARR_INDEX_B: 4, _ARR_INDEX_RR: 2, _ARR_INDEX_RB: 5, _ARR_INDEX_BB: 8,
                   _ARR_INDEX_BR: 3}
    ...
    @classmethod
    def createBitBoardFrom(self, matrix, mode=False):
        ...
        for row in range(matrix.shape[0]):
            for col in range(matrix.shape[1]):
                match matrix[row][col]:
                    case 1:
                        bitboardArray[self._ARR_INDEX_R] = bitboardArray[self._ARR_INDEX_R] | (
                                    np.uint64(1) << np.uint64(helperMatrix[row][col]))
                    case 2:
                        bitboardArray[self._ARR_INDEX_RR] = bitboardArray[self._ARR_INDEX_RR] | (
                                    np.uint64(1) << np.uint64(helperMatrix[row][col]))
                    case 3:
                        bitboardArray[self._ARR_INDEX_BR] = bitboardArray[self._ARR_INDEX_BR] | (
                                    np.uint64(1) << np.uint64(helperMatrix[row][col]))
                    case 4:
                        bitboardArray[self._ARR_INDEX_B] = bitboardArray[self._ARR_INDEX_B] | (
                                    np.uint64(1) << np.uint64(helperMatrix[row][col]))
                    case 5:
                        bitboardArray[self._ARR_INDEX_RB] = bitboardArray[self._ARR_INDEX_RB] | (
                                    np.uint64(1) << np.uint64(helperMatrix[row][col]))
                    case 8:
                        bitboardArray[self._ARR_INDEX_BB] = bitboardArray[self._ARR_INDEX_BB] | (
                                    np.uint64(1) << np.uint64(helperMatrix[row][col]))
                    case _:
                        continue
        ...
        if (mode == True):
            ...
            bBoardZuggen[self._ZARR_INDEX_R_KNIGHTS] = bitboardArray[self._ARR_INDEX_RR] | bitboardArray[
                self._ARR_INDEX_BR]
            bBoardZuggen[self._ZARR_INDEX_B_PAWNS] = bitboardArray[self._ARR_INDEX_B]
            bBoardZuggen[self._ZARR_INDEX_B_KNIGHTS] = bitboardArray[self._ARR_INDEX_BB] | bitboardArray[
                self._ARR_INDEX_RB]
            return bBoardZuggen
    ...
    def fromBitBoardToMatrix(self, BB: list, mode=False):
        ...
        # TODO
        if (mode == False):
            figures = [self._ARR_INDEX_B, self._ARR_INDEX_BR, self._ARR_INDEX_BB, self._ARR_INDEX_R, self._ARR_INDEX_RB,
                       self._ARR_INDEX_RR]
            figures.sort()
